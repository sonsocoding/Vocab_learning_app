...
val Forgot = Color(0xFFD66F5C)
val ForgotSoft = Color(0xFFFBEDEA)
val Learning = Color(0xFFC08A32)
val LearningSoft = Color(0xFFFBF3E1)
val Mastered = Color(0xFF4C9276)
val MasteredSoft = Color(0xFFE8F4EE)
